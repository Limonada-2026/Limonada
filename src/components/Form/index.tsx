...
const lightStyle = 'border-green-light focus-visible:outline-green-light text-green-light autofill:shadow-[0_0_0_1000px_var(--color-green-dark)_inset] autofill:[-webkit-text-fill-color:var(--color-green-light)]';
const darkStyle = 'border-gray-light focus-visible:outline-green-dark text-green-dark autofill:shadow-[0_0_0_1000px_var(--color-white)_inset]';

//-webkit-text-fill-color: var(--color-green-light) !important;
...
export const Checkbox = ({
	...
	return (
		<div className={clsx(
			...
			<label
				htmlFor={id}
				className='has-[input:checked]:**:data-radio-box:bg-black has-[input:focus]:**:data-radio-box:outline-1 has-[input:focus]:**:data-radio-box:outline-gray-light flex'
