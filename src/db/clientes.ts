...
const allCases: Case[] = [
    ...
    },
    {
        ...
        blocks: [
            { title: 'Strategy Maker', text: 'Construção da visão Oxford 2030 e definição das prioridades estratégicas do negócio, com foco em crescimento, execução e alinhamento organizacional.' },
            { title: 'Culture Strategy', text: 'Fortalecimento da cultura e desenvolvimento de lideranças capazes de traduzir valores em comportamentos, conectando cultura e estratégia para sustentar a transformação.' },
            { title: 'Innovation Makers', text: 'Jornada prática que conecta estratégia, transformação digital e execução para transformar oportunidades em projetos reais de negócio.' },
            { title: 'Comitê S&OP', text: 'Estrutura de governança que fortalece o planejamento integrado entre áreas, trazendo mais previsibilidade, eficiência e qualidade para a tomada de decisão.' }
        ],
        numbers: [
    ...
    },
    {
        ...
        numbers: [
            { number: 25, rangeEnd: 27, text: 'Construção da visão futura da companhia' },
